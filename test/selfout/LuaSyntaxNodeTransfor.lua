...
System.namespace("CSharpLua", function (namespace) 
    namespace.class("LuaSyntaxNodeTransfor", function (namespace) 
        ...
        GetCallerAttributeKind1, IsCallerAttribute, CheckCallerAttribute, CheckUsingStaticNameSyntax, MayBeFalse, MayBeNull, MayBeNullOrFalse, CheckTypeName, 
        GetTypeShortName, VisitObjectCreationExpression, BuildObjectInitializerExpression, VisitInitializerExpression, VisitBracketedArgumentList, VisitImplicitElementAccess, VisitGenericName, VisitOmittedArraySizeExpression, 
        VisitArrayRankSpecifier, VisitArrayType, FillMultiArrayInitializer, VisitArrayCreationExpression, VisitConstructorDeclaration, VisitSimpleBaseType, VisitLambdaExpression, VisitSimpleLambdaExpression, 
        ...
        VisitMemberBindingExpression, VisitDefaultExpression, VisitElementAccessExpression, VisitInterpolatedStringExpression, VisitInterpolation, VisitInterpolatedStringText, __staticCtor__, __init__, 
        __ctor__;
        ...
        VisitEnumDeclaration = function (this, node) 
            ...
            local name = CSharpLua.LuaAst.LuaIdentifierNameSyntax:new(1, node:getIdentifier():getValueText());
            local enumDeclaration = CSharpLua.LuaAst.LuaEnumDeclarationSyntax(symbol:ToString(), name, getCurCompilationUnit(this));
        ...
        VisitBlock = function (this, node) 
            ...
            local commentNodes = Linq.Select(comments, function (i) return CSharpLua.LuaSyntaxNodeTransfor.BlockCommonNode:new(1, i); end, CSharpLua.LuaSyntaxNodeTransfor.BlockCommonNode);

            local nodes = Linq.ToList(Linq.Select(node:getStatements(), function (i) return CSharpLua.LuaSyntaxNodeTransfor.BlockCommonNode:new(2, i); end, CSharpLua.LuaSyntaxNodeTransfor.BlockCommonNode));
        ...
        WrapStringConcatExpression = function (this, expression) 
            ...
            elseif typeInfo:getTypeKind() == 5 --[[TypeKind.Enum]] then
                if System.is(original, CSharpLua.LuaAst.LuaLiteralExpressionSyntax) then
                    ...
                    return CSharpLua.LuaAst.LuaConstLiteralExpression:new(1, symbol:getName(), typeInfo:ToString());
                else
                    this.generator_:AddExportEnum(typeInfo:ToString());
                    local typeName = GetTypeShortName(this, typeInfo);
                    local memberAccess = CSharpLua.LuaAst.LuaMemberAccessExpressionSyntax(original, CSharpLua.LuaAst.LuaIdentifierNameSyntax.ToEnumString, true);
        ...
        BuildCodeTemplateExpression = function (this, codeTemplate, targetExpression) 
            return BuildCodeTemplateExpression1(this, codeTemplate, targetExpression, System.Array.Empty(Microsoft.CodeAnalysis.CSharp.Syntax.ExpressionSyntax), SystemCollectionsImmutable.ImmutableArray_1(Microsoft.CodeAnalysis.ITypeSymbol).Empty);
        end;
        ...
        CheckTypeName = function (this, identifierName, symbol) 
            local name = identifierName.ValueText;
            local pos = name:LastIndexOf(46 --[['.']]);
            if pos ~= - 1 then
                local prefix = name:Substring(0, pos);
                if prefix ~= CSharpLua.LuaAst.LuaIdentifierNameSyntax.System.ValueText then
        ...
        GetTypeShortName = function (this, symbol) 
            local identifierName = getXmlMetaProvider(this):GetTypeShortName(symbol);
            identifierName = CheckTypeName(this, identifierName, symbol);
            ...
            for _, expression in System.each(node:getExpressions()) do
                if Microsoft.CodeAnalysis.CSharpExtensions.IsKind(expression, 8714 --[[SyntaxKind.SimpleAssignmentExpression]]) then
                    ...
                    if Microsoft.CodeAnalysis.CSharpExtensions.IsKind(assignment:getLeft(), 8656 --[[SyntaxKind.ImplicitElementAccess]]) then
                        ...
                        function_:AddStatement1(CSharpLua.LuaAst.LuaAssignmentExpressionSyntax(identifierName, right));
                    end
                else
                    ...
                    function_:AddStatement1(CSharpLua.LuaAst.LuaInvocationExpressionSyntax:new(2, memberAccess, value));
                end
            end
        ...
        VisitGenericName = function (this, node) 
            ...
            if symbol:getKind() == 9 --[[SymbolKind.Method]] then
                ...
                local name = GetTypeShortName(this, symbol);
        ...
        VisitLambdaExpression = function (this, parameters, body) 
            ...
            if Microsoft.CodeAnalysis.CSharpExtensions.IsKind(body, 8792 --[[SyntaxKind.Block]]) then
                ...
                this.blocks_:Pop();
                function_:AddStatement(CSharpLua.LuaAst.LuaReturnStatementSyntax:new(1, expression));
        ...
        VisitMemberBindingExpression = function (this, node) 
            ...
            functionExpression:AddStatement(CSharpLua.LuaAst.LuaReturnStatementSyntax:new(1, nameExpression));
            PopFunction(this);
        ...
        return {
            __inherits__ = {
                MicrosoftCodeAnalysisCSharp.CSharpSyntaxVisitor_1(CSharpLua.LuaAst.LuaSyntaxNode)
            }, 
