...
System.namespace("CSharpLua.LuaAst", function (namespace) 
    namespace.class("LuaIdentifierNameSyntax", function (namespace) 
        ...
        Int, UsingDeclare, Global, Render, __staticCtor__, __ctor1__, __ctor2__;
