...
QUnit.test("#1640", function (assert) {
    var game1: TypeScript.Issues.N1640.GamePlay = new TypeScript.Issues.N1640.GamePlay();

    var result1: String;
    let s1 = function (sender: System.Object, s: String): void { result1 = s + "1"; };
    ...
    var result2: String;
    let s2 = function (sender: System.Object, s: String): void { result2 = s + "2"; };

    var iGame2: TypeScript.Issues.N1640.IGamePlay = game2;
...
QUnit.test("#2133", function (assert) {
    var task = new System.Threading.Tasks.Task$1<Number>(() => { return 5; });
    assert.ok(task != null);
});
...
QUnit.test("#2661", function (assert) {
    ...
    c.fn = function (x: TypeScript.Issues.N2661C) { return x.fn; };
