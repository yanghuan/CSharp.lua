...
#region if else switch
    ...
    private LuaExpressionSyntax WrapStringConcatExpression(ExpressionSyntax expression) {
      ...
      if (typeInfo.SpecialType == SpecialType.System_Char) {
      ...
      if (typeInfo.SpecialType is >= SpecialType.System_Boolean and <= SpecialType.System_Double) {
    ...
    public override LuaSyntaxNode VisitPrefixUnaryExpression(PrefixUnaryExpressionSyntax node) {
      ...
      switch (kind) {
        ...
        case SyntaxKind.PreDecrementExpression: {
          ...
          if (operand is LuaPropertyAdapterExpressionSyntax propertyAdapter) {
